<template>
  <div class="bg-login">
    ...
    <div class="text-center mt-24">
      ...
      <span class="text-sm">or <nuxt-link to="login" class="text-light">
    ...
    <div class="flex justify-center my-2 mx-4 md:mx-0">
      <form @submit.prevent="login()" class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Password'>Password
              Confirmation</label>
            <input v-model="password_c"
  ...
  export default {
    data() {
      return {
        ...
        head() {
      return {
        title: "Rotten Tomatoes | Register",
      }
  },
    methods: {
      login() {
