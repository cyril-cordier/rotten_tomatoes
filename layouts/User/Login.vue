  ...
  <div class="bg-login">
    ...
    <div class="text-center mt-24">
      <div class="flex items-center justify-center">
        <svg fill="none" viewBox="0 0 24 24" class="w-12 h-12 text-white-500" stroke="currentColor">
      ...
      <span class="text-sm">or <nuxt-link to="register" class="text-light">
    ...
    <div class="flex justify-center my-2 mx-4 md:mx-0">
      <form @submit.prevent="login()" class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
        <div class="flex flex-wrap -mx-3 mb-6">
                       <div class="alert alert-success w-100 text-center" v-if="success != null" role="alert">
                  <p>You have logged successfully !</p>
            </div>
                              <div class="alert alert-danger w-100 text-center" v-if="error != null" role="alert">
                  <p>{{error}}</p>
            </div>
    ...
    methods:{
       login(){
          var myHeaders = new Headers();
            ...
            fetch("https://nuxt-tomatoes.herokuapp.com/api/users/login", requestOptions)
